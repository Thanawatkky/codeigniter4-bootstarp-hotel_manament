...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html"><span>DD Hotel</span></a></h1>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Welcome</h1>
          <h2>Welcome to DD Hotel.</h2>
          <div>
            <a href="/Register" class="btn-get-started scrollto">Get Started</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="homepage/img/hero-img.svg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
            <img src="homepage/img/about-img.svg" class="img-fluid" alt="" data-aos="zoom-in">
          </div>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 d-block mx-auto" data-aos="zoom-in" data-aos-delay="100">
            <div class="member">
              <img src="homepage/img/team/profile.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Thanawat Chueanongprong</h4>
                  <span>Fullstack</span>
                </div>
                <div class="social">
                  <a href="https://web.facebook.com/profile.php?id=100011037727935" target="_blank"><i class="bi bi-facebook"></i></a>
                  <a href="https://www.instagram.com/dung_tanw/" target="_blank"><i class="bi bi-instagram"></i></a>
                </div>
              </div>
            </div>
          </div>
