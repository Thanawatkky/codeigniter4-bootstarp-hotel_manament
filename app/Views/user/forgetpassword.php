...
<div class="container rounded-3 bg-white border shadow-sm ">
        <div class="text-center pt-4">
            <h4 class="fw-bold mt-4">เปลี่ยนรหัสผ่าน 🔒</h4>
        </div>

        <form class="needs-validation mt-4" action="/user/forgetpassword" method="post" id="frm_repass" novalidate>
            <div class="row px-5">
            ...
            <div class="text-center mt-5">
                ...
                <a href="/user/index" class="btn btn-dark mb-5" style="width: 130px;">ยกเลิก</a>
            </div>
        </form>
    </div>
<?= $this->endsection(); ?>