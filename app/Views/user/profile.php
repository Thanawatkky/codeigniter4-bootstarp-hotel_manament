...
?>
    <div class="container rounded-3 bg-white shadow-sm mt-3 ">
        ...
        <form class="needs-validation" id="frm_profile" enctype="multipart/form-data" action="/user/profile" method="post" novalidate>
            <div class="row px-5">
            ...
            <div class="text-center mt-5">
                ...
                <a href="/user/dashboard" class="btn btn-dark mb-4" style="width: 130px;">ยกเลิก</a>
            </div>
        </form>
    </div>
    <?php 
